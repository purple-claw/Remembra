  ...
  if (mode === 'chat') {
    return (
      <div className="min-h-[100dvh] bg-black lined-bg-subtle flex flex-col smooth-scroll-content">
        ...
        <main ref={chatViewportRef} className="flex-1 px-4 sm:px-5 py-4 overflow-y-auto custom-scrollbar space-y-3" onScroll={onScroll}>
  ...
  if (mode === 'tools') {
    ...
    return (
      <div className="min-h-[100dvh] bg-black lined-bg-subtle flex flex-col smooth-scroll-content">
        ...
        <main className="flex-1 px-4 sm:px-5 py-4 overflow-y-auto custom-scrollbar space-y-4" onScroll={onScroll}>
