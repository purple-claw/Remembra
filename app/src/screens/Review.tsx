      ...
      >
        ...
        <div className="bg-remembra-bg-secondary rounded-2xl border border-white/10 mb-4">
          <div className="p-5 overflow-hidden">
            <div className="prose prose-invert prose-sm max-w-none prose-headings:text-white prose-headings:font-bold prose-p:text-remembra-text-secondary prose-p:leading-relaxed prose-a:text-remembra-accent-primary prose-a:underline prose-strong:text-white prose-code:text-remembra-accent-secondary prose-code:bg-black/50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:bg-black/70 prose-pre:border prose-pre:border-white/10 prose-pre:rounded-xl prose-pre:overflow-x-auto prose-pre:max-w-full prose-ul:text-remembra-text-secondary prose-ol:text-remembra-text-secondary prose-li:my-1 [&_pre]:!overflow-x-auto [&_pre_code]:!whitespace-pre [&_pre]:!max-w-[calc(100vw-4rem)] [&_pre]:touch-pan-x">
